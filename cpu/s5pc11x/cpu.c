...
#ifdef CONFIG_LCD //forlinx.bs
    #define Outp32(addr, data)	(*(volatile u32 *)(addr) = (data))
    Outp32(0xf8000100, 0x0);
    Outp32(0xf8000044, 0x0);
    Outp32(0xf8000048, 0x0);
#elif defined(CONFIG_VIDEO) //forlinx.bs
    #define Outp32(addr, data)	(*(volatile u32 *)(addr) = (data))
#if 1//debug
    Outp32(0xf8000024, 0x0);  //WINCON1 Window 1 Buffer set 0  //if add other, screen flash  forlinx.zcg
#else     
