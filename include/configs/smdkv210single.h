...
#define FORLINX_DEBUG   1                       /*forlinx debug info*/
...
//#define CONFIG_BOOTARGS    	"console=ttySAC2,115200 rootfstype=yaffs2 root=/dev/mtdblock2 init=/linuxrc"//forlinx.bs
#define CONFIG_BOOTARGS    	"console=ttySAC2,115200 root=/dev/mtdblock3 init=/linuxrc"   //mtdblock3 forlinx.zcg
#elif defined(CONFIG_ANDROID_FORLINX)
#define CONFIG_BOOTARGS    	"console=ttySAC2,115200 rootfstype=yaffs2 root=/dev/mtdblock3 init=/init"
#endif
...
#define CFG_UBOOT_BASE		    0xcc800000

#else
//#define CFG_UBOOT_BASE		0x23e00000
#define CFG_UBOOT_BASE		    0x2c800000

#endif

//#define CFG_PHY_UBOOT_BASE	MEMORY_BASE_ADDRESS + 0x3e00000

//forlinx add 	/*  200M offset in DRAM	for dnw larger files*/
#define CFG_PHY_UBOOT_BASE	MEMORY_BASE_ADDRESS + 0xc800000
...
//forlinx.bs
//forlinx.bs config2
//#define CONFIG_LCD_SIZE_4   // 4 5 7 8 10 VGA
//#define CONFIG_LCD_SIZE_5   // 4 5 7 8 10 VGA
//#define CONFIG_LCD_SIZE_7   // 4 5 7 8 10 VGA
//#define CONFIG_LCD_SIZE_8   // 4 5 7 8 10 VGA
#define CONFIG_LCD_SIZE_10   // 4 5 7 8 10 VGA
//#define CONFIG_LCD_SIZE_VGA   // 4 5 7 8 10 VGA
#define CONFIG_VIDEO  1//use lcd console //#define CONFIG_VIDEO              //Video support
#ifdef CONFIG_VIDEO
    ...
    //#define LCD_VIDEO_ADDR   CFG_LCD_FBUFFER//(0x48000000)//根据开发板的内存地址配置
