...
int nand_write_opts(nand_info_t *meminfo, const nand_write_options_t *opts)
{
    ...
    while (imglen && (mtdoffset < meminfo->size))
    {
        ...
        {
			readlen = imglen;
			memset(data_buf + readlen, 0xff,  meminfo->writesize - readlen);
		}
    ...
    printf("X210 ------before write page  readlen=%d...........\n",readlen);
    ...
    while (ii--)
    {
        ...
        if (opts->writeoob)
        {
            ...
            //forlinx add
          //  memset(oob_buf,0xFF,MAX_OOB_SIZE);
         //   printf("read OOB data from input memory block\n");
