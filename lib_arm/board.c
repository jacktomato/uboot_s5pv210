...
#endif
#define CONFIG_MODIFY_STRING "FORLINX EMBEDDED"
const char version_string[] =
    CONFIG_MODIFY_STRING" "U_BOOT_VERSION" (" __DATE__ " - " __TIME__ ")"CONFIG_IDENT_STRING;
...
//led debug GPC1(4)///GPC1CON 0xE020_0080
#define REG_GPC1_4CON    (0xE0200080)
//GPC1_4DAT 0x020_0084
#define REG_GPC1_4DAT    (0xE0200084)
void trunoffled()
{
    int i=0;
    ...
    //GPC1_4CON coreboard led
    //writel(0x10000,REG_GPC1_4CON);
    //GPC1_4DAT
    //writel(0x10,REG_GPC1_4DAT);
}
//forlinx.bs
