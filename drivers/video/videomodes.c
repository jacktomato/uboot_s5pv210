...
const struct ctfb_vesa_modes vesa_modes[VESA_MODES_COUNT] = {
	...
	{0x212, RES_MODE_480x272_4, 16},  // 4.3
	{0x213, RES_MODE_800x480_5, 16},  // 5.0
	{0x214, RES_MODE_800x480_7, 16},  // 7.0
	{0x215, RES_MODE_800x600_8, 16},  // 8.0
	{0x216, RES_MODE_800x600_10, 16},  // 10.4
	{0x217, RES_MODE_800x600_vga, 16},  // vga
...
const struct ctfb_res_modes res_mode_init[RES_MODES_COUNT] = {
	...
	{480, 272, 150150, 2, 2, 2, 2, 41, 10, 0, FB_VMODE_NONINTERLACED},//4.3lcd
	{800, 480, 50150, 40, 40, 13, 29, 48, 3, 0, FB_VMODE_NONINTERLACED},//5.0lcd
	{800, 480, 15151, 16, 48, 6, 4, 32, 0, 0, FB_VMODE_NONINTERLACED},//7.0lcd
	{800, 600, 50150, 40, 40, 13, 29, 48, 3, 0, FB_VMODE_NONINTERLACED},//8.0lcd
	{800, 600, 50150, 40, 40, 13, 29, 48, 3, 0, FB_VMODE_NONINTERLACED},//10.4lcd
	{800, 600, 720302, 100, 198, 5, 29, 31, 4, 0, FB_VMODE_NONINTERLACED},//vgalcd
};
